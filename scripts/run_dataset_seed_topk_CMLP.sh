                            ...
                            for temp_scheme in "${temp_scheme_list[@]}"; do
                                for temperature in "${temperature_list[@]}"; do
                                    ...
                                    # set the model_path based on method
                                               #output/CMLP_vitb32_openclip_laion400m_50epochs/output_semi-aves/semi-aves_CMLP_fewshot_REAL-Prompt_4shots_seed1/stage1_model_best.pth                                               
                                    model_path="output/${method}_${model_cfg}_50epochs/output_${dataset}/${dataset}_${method}_fewshot_${init}_${shots}shots_seed${seed}/stage1_model_best.pth"
