...
METHOD_WITH_FROZEN_BACKBONES = set(['zeroshot', 'probing', 'CMLP', 'CLAP'])
...
def get_engine(model_cfg, device = 'cuda', mode='val'):
    ...
    if model_name == 'clip':
        ...
        model, train_preprocess, preprocess = open_clip.create_model_and_transforms('hf-hub:imageomics/bioclip')
