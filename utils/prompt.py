...
def get_prompts_tensors(args, model, tokenizer, logger):
    ...
    # metric_fn = f'{dataset_root}/{args.dataset}_labels.json'
    
    if args.dataset =='fungiastic-m' or args.dataset == 'fish-vista-m':
        metric_fn = f'{dataset_root}/{args.dataset}_labels_enriched.json'
    else:
        metric_fn = f'{dataset_root}/{args.dataset}_labels.json'
...
species196_insecta_templates = [
    'a photo of a {}, a type of insect.',
]
species196_weeds_templates = [
    'a photo of a {}, a type of weed.',
]
species196_mollusca_templates = [
    'a photo of a {}, a type of mollusca.',
    'a photo of the {}, a type of mollusca.',
    'a close-up photo of a {}, a type of mollusca.',
    'a close-up photo of the {}, a type of mollusca.',
    'a bright photo of a {}, a type of mollusca.',
    'a bright photo of the {}, a type of mollusca.',
    'a dark photo of a {}, a type of mollusca.',
    'a dark photo of the {}, a type of mollusca.',
]

fungitastic_m_templates = [
    'a photo of a {}, a type of fungus.',
]

fish_vista_templates = [
...
TEMPLATES_DIC = {
    ...
    'species196_insecta': species196_insecta_templates,
    'species196_weeds': species196_weeds_templates,
    'species196_mollusca': species196_mollusca_templates,
    'fungitastic-m': fungitastic_m_templates,
    'fish-vista-m': fish_vista_templates,
}
